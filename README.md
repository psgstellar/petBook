...
clone 후 : .../petBook 경로에서 `yarn -v` 입력시 3.2.0 버전이 나타나는지 확인 해주세요 !
...
#### **.../petBook/petbook-front 로 이동해서 바로 yarn start**
...
```
{
	...
	"settings": {
                  ...
                  // ex) petBook 를 기준으로 워크스페이스가 열렸다면 petBook 부터 시작
		"typescript.tsdk": "./petbook-front/.yarn/sdks/typescript/lib"
	},
}
```
...
1. petBook/petbook-front/.vscode/settings.json 파일을 엽니다.
